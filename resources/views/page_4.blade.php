...
<input  placeholder="$0.00" style="  
       ...
       <a class="btn btn-lg" onclick="myFunction()" style="float: right;color: #212529;background-color: #FFFFFF;border-color: #FFFFFF;margin-right: 10px;" href="{{ route('dashboard')}}" role="button" >Continue</a>
...
<footer class="page-footer font-small">
  ...
  <div style="color:black;" class="footer-copyright text-center py-3">© 2020 Copyright:
    ...
    <script>
      localStorage.setItem("number","selectNum");
  </script>  
