...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    ...
    <meta name="author" content="">
        ...
        <!-- Styles -->
            ...
            <link rel="stylesheet" href="<?php echo e(asset('css/fullpage.min.css')); ?>">
    ...
    <body>
        ...
        <script src="<?php echo e(asset('js/fullpage.min.js')); ?>" type="text/javascript" ></script>
        <script src="<?php echo e(asset('js/scrolloverflow.js')); ?>" type="text/javascript" ></script>
        <script src="<?php echo e(asset('js/owl.carousel.min.js')); ?>" type="text/javascript" ></script>
        <script src="<?php echo e(asset('js/jquery.inview.min.js')); ?>" type="text/javascript" ></script>
        <script src="<?php echo e(asset('js/form.js')); ?>" type="text/javascript" ></script>
                        ...
                        <nav id="navigation">
                            ...
                            <div class="nav-box navbar-collapse">
                                <ul class="navigation-menu nav navbar-nav navbars" id="nav">
                                    ...
                                    <li ><a href="<?php echo e(route('login')); ?>"><strong>Login </strong></a></li>

                                    <li ><a href="<?php echo e(route('register')); ?>"><strong>Sign Up </strong></a></li> 
...
<?php /**PATH /Users/mikael/Documents/GitHub/budget-better/BudgetBetter/resources/views/welcome.blade.php ENDPATH**/ ?>